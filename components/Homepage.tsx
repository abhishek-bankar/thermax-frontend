    ...
    <main className="min-h-dvh bg-[#f6f6f6] p-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          <div>
            <Link href={SIGN_IN} onClick={() => setLoading(true)}>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2 p-4">
          <h3 className="text-center text-lg font-bold tracking-wider text-slate-700">
            INTRODUCING THE FOREFRONT OF ELECTRICAL AND INSTRUMENTATION
            INNOVATION EnIMAX
          </h3>
          <h2 className="text-justify text-sm font-semibold text-slate-800">
            EnIMAX serves as an advanced engineering authoring tool, empowering
            engineers and designers to swiftly generate superior electrical and
            instrumentation designs and deliverables. With its capability to
            distribute discipline-specific data and designs within project
            teams, EnIMAX enables instantaneous collaboration among electrical
            and instrumentation disciplines, revolutionizing project dynamics
          </h2>
        </div>
      </div>
    </main>
