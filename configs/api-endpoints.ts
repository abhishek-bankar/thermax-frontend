...
export const TRCC_PANEL = `/document/TRCC Panel`;
...
export const EMAIL_VERIFICATION_API =
  "/method/thermax_extended_user.trigger_email_verification_mail";
export const CREDENTIALS_EMAIL_API =
  "/method/thermax_extended_user.trigger_send_credentials";
...
export const DELETE_USER_EMAIL_API =
  "/method/thermax_extended_user.trigger_delete_user";
export const APPROVER_EMAIL_NOTIFICATION_API =
  "/method/project.trigger_approver_notification_mail";
export const REVIEW_SUBMISSION_EMAIL_API =
  "/method/db_revision.trigger_review_submission_mail";
export const REVIEW_RESUBMISSION_EMAIL_API =
  "/method/db_revision.trigger_review_resubmission_mail";
export const REVIEW_APPROVAL_EMAIL_API =
  "/method/db_revision.trigger_review_approval_mail";
...
export const PANEL_SPECS_REVISIONS_API = `/document/Panel Specifications Revisions`;
